...
//---------------------------------------------------
// T.Shimada Develop
int ComponentElmer::GetElementNumber(const double xin, const double yin, const double zin){
...
int ComponentElmer::GetMaterialNumber(const double xin, const double yin, const double zin){
