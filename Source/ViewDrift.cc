...
// T.Shimada Develop
void ViewDrift::NewNegativeIonDriftLine(const unsigned int np, int& id, const double x0,
                                        const double y0, const double z0) {
  DriftLine d;
  Marker m0;
  m0.x = x0;
...
void ViewDrift::NewNegativeIonAndElectronDriftLine(const unsigned int np, int& id, const double x0,
                                                   const double y0, const double z0) {
  DriftLine d;
  Marker m0;
  m0.x = x0;
