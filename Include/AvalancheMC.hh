...
class AvalancheMC {
 public:
  ...
  unsigned int GetNumberOfNegativeIonEndpoints() const {
    return m_endpointsNegativeIons.size();
  }
  ...
  void GetIonEndpoint(const unsigned int i, double& x0, double& y0, double& z0,
                      double& t0, double& x1, double& y1, double& z1,
                      double& t1, int& status) const;
  void GetNegativeIonEndpoint(const unsigned int i, double& x0, double& y0, double& z0,
                              double& t0, double& x1, double& y1, double& z1,
                              //double& t1, int& status);
                              double& t1, int& status) const;
...
//---------------------------------------------------------
 ...
 private:
  ...
  /// Endpoints of all negative ions in the avalanche
  std::vector<EndPoint> m_endpointsNegativeIons;
...
//---------------------------------------------------------
  ...
  int DetachmentNegativeIon(const double step, Medium* medium,
                            const std::array<double, 3>& e,
                            const std::array<double, 3>& v,
