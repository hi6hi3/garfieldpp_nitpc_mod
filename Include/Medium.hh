...
class Medium {
 public:
  ...
  virtual void GetElectronMomentum(const double e, double& px, double& py,
                                   double& pz, int& band);
  virtual void GetNegativeIonMomentum(const double e, const double niMass, double& px, double& py,
                                   double& pz, int& band);
...
///----------------------------------------------------------------------------
  // Transport parameters for ions
  virtual bool NegativeIonVelocity(const double ex, const double ey, const double ez,
                                   const double bx, const double by, const double bz,
                                   double& vx, double& vy, double& vz);
  virtual bool NegativeIonDiffusion(const double ex, const double ey, const double ez,
                                    const double bx, const double by, const double bz,
                                    double& dl, double& dt);
  /// Dissociation coefficient
  virtual bool NegativeIonDissociation(const double ex, const double ey,
                                       const double ez, const double bx,
                                       const double by, const double bz, double& diss);
///----------------------------------------------------------------------------
